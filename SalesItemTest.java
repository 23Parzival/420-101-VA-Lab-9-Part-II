...
public class SalesItemTest
{
    ...
    {
        SalesItem salesIte1 = new SalesItem("test", 123);
        assertEquals(true, salesIte1.addComment("test", "test", 2));
        assertEquals("test", salesIte1.getName());
    }

    @Test
    public void test2GetMostHelpfulComment()
    {
        SalesItem salesIte1 = new SalesItem("test", 123);
